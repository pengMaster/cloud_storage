package king.cloud.camara.mvp.p;
...
import king.cloud.camara.bean.LockStage;
import king.cloud.camara.mvp.contract.GestureCreateContract;
import king.cloud.camara.utils.LockPatternUtils;
import king.cloud.camara.widget.LockPatternView;

import static king.cloud.camara.bean.LockStage.ChoiceConfirmed;
import static king.cloud.camara.bean.LockStage.ChoiceTooShort;
import static king.cloud.camara.bean.LockStage.ConfirmWrong;
import static king.cloud.camara.bean.LockStage.FirstChoiceValid;
import static king.cloud.camara.bean.LockStage.Introduction;
import static king.cloud.camara.bean.LockStage.NeedToConfirm;
