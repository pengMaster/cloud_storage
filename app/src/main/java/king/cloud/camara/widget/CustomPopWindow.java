...
public class CustomPopWindow implements PopupWindow.OnDismissListener {
     ...
     */
    private boolean enableOutsideTouchDisMiss = false;// 默认点击pop之外的地方不可以关闭
    ...
    private PopupWindow build() {
        ...
        if (mAnimationStyle != -1) {
            ...
            mPopupWindow.setAnimationStyle(R.style.ppw_anim_style);
        }
    ...
    public static class PopupWindowBuilder {
        ...
        /**
         * 设置是否允许点击按键 PopupWindow之外的地方，关闭PopupWindow
         *
         * @param isEnableBack
         */
        public PopupWindowBuilder enableBackDissmiss(boolean isEnableBack) {
            mCustomPopWindow.mIsEnableBack = isEnableBack;
            return this;
        }
