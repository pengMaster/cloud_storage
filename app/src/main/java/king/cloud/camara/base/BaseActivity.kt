...
import king.cloud.camara.utils.StatusBarCompat
import king.cloud.camara.utils.ToastUtils
import king.cloud.camara.widget.ShapeLoadingDialog
...
abstract class BaseActivity : AppCompatActivity(),EasyPermissions.PermissionCallbacks {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        initData()
        start()
        StatusBarCompat.compat(this, resources.getColor(R.color.green_top))
